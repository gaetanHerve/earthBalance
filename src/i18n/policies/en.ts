...
export const policyI18n: Record<string, PolicyI18n> = {
  ...
  'dec-42-07': {
    title: 'Global carbon tax at $150/tonne by 2030?',
    description: `This proposal aims to establish a universal carbon tax of **$150/tonne of CO₂** applicable to all Paris Agreement signatories by 2030. Revenues would be redistributed: 60% to developing countries to finance the energy transition, and 40% to a global climate adaptation fund. Key issues: industrial competitiveness, climate justice, and effectiveness of emissions reduction.`,
  ...
  'dec-42-06': {
    ...
    description: 'Ban all primary forest logging by 2025 through a binding international treaty.',
  ...
  'dec-42-05': {
    title: 'Coal phase-out in developed countries\' electricity sector by 2030',
    description: `Planned closure of all coal-fired power plants without CO₂ capture in Annex I countries (OECD + EU) by end-2030. The transition would be supported by a retraining plan for mining communities and a compensation mechanism for still-dependent countries. According to AR6 WGIII, coal accounts for ~30% of global energy-related CO₂ emissions; developed countries contribute ~45%. This measure aligns with C1 (1.5°C) pathways requiring a **67%** [46–86%] reduction in global coal electricity generation by 2030.`,
  ...
  'dec-42-04': {
    title: '34% global methane emissions reduction by 2030',
    description: `Methane is a greenhouse gas **80 times more potent** than CO₂ over 20 years. Unlike CO₂, its short atmospheric lifetime (~12 years) means rapid reductions translate into measurable cooling within the following decade. IPCC 1.5°C pathways require a 34% reduction in global CH₄ emissions by 2030. Main sources — agriculture (livestock, rice), fossil fuels (gas leaks) and waste — are all amenable to targeted policies.`,
    summary: `Methane is a greenhouse gas 80 times more potent than CO₂ over 20 years. Unlike CO₂, its short atmospheric lifetime (~12 years) means that rapid reductions translate into measurable cooling within the following decade. IPCC 1.5°C scenarios require a 34% reduction in global CH₄ emissions by 2030. The main sources are agriculture (livestock, rice), fossil fuels (gas leaks) and waste — all amenable to targeted policies.`,
  ...
  'dec-42-03': {
    title: 'Halt tropical deforestation and restore forests by 2030',
    description: `Tropical forests harbour over 50% of terrestrial biodiversity and store 250 billion tonnes of carbon. Their deforestation accounts for approximately 10% of annual global emissions. Halting destruction and restoring 350 Mha by 2030 could sequester an additional **1.5–3 GtCO₂/year**. These measures rank among the most cost-effective in the IPCC catalogue, at less than **$20/tCO₂** for protecting existing forests.`,
    summary: `Tropical forests harbour more than 50% of terrestrial biodiversity and store 250 billion tonnes of carbon. Deforestation accounts for approximately 10% of annual global emissions. Halting destruction and restoring 350 Mha by 2030 could sequester an additional 1.5–3 GtCO₂/year. These measures rank among the most cost-effective identified by the IPCC, at less than $20/tCO₂ for protecting existing forests.`,
  ...
  'dec-42-01': {
    title: 'Electrification of land transport and sustainable mobility by 2050',
  ...
  'dec-42-08': {
    title: 'Massive deployment of solar and wind: 100% decarbonised electricity by 2050',
  ...
  'dec-42-09': {
    title: 'Universal deep energy retrofit of buildings by 2050: zero fossil fuels',
  ...
  // ─── dec-42-12 — Nuclear ────────────────────────────────────────────────────
  'dec-42-12': {
    title: 'Nuclear expansion as decarbonised baseload: double capacity by 2050',
  ...
  'dec-42-14': {
    title: '50% reduction in global food waste and loss by 2030 (SDG 12.3)',
    description: `**One-third** of the world's food production is lost or wasted — representing 8–10% of global GHG emissions. Reducing this waste by **50% by 2030** (SDG 12.3) would eliminate 2–4 GtCO₂eq/year without requiring major technological change. It is one of the most cost-effective mitigation options identified by the IPCC, with co-benefits for global food security.`,
