...
export const mitigationPolicies: MitigationPolicy[] = [
  // ─── Décision existante 42-07 ─────────────────────────────────────────────
  {
    ...
    projections: {
      labels: [2024, 2026, 2028, 2030, 2034, 2040, 2050, 2060, 2074],
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 68.7, 70.3, 72.3, 75.4, 79.4, 85.1, 92.5],
        pessimist: [65.2, 67.2, 69, 71.1, 73.9, 78.1, 84.1, 89.8, 97.2],
      },
      temperature: {
  ...
  // ─── Décision 05 — Modèle : POL_COAL_EXIT_2030_DEV ────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69, 70.5, 72.6, 75.7, 79.7, 85.4, 92.8],
        pessimist: [65.2, 67.2, 69.2, 71.2, 74, 78.3, 84.2, 89.9, 97.3],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 04 — Modèle : POL_METHANE_REDUCTION_2030 ────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 66.6, 66.8, 69.9, 75.5, 83.2, 88.9, 96.3],
        pessimist: [65.2, 67.2, 68.1, 69.9, 73.3, 78.1, 85.5, 91.2, 98.6],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 03 — Modèle : POL_DEFORESTATION_HALT_2030 ───────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 70.6, 72.3, 76.9, 84.2, 89.9, 97.3],
        pessimist: [65.2, 67.2, 69.3, 71.3, 73.9, 78.3, 85.5, 91.2, 98.6],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
      ...
      forest: {
        // % forêts primaires mondiales — baseline SSP3-7.0 [AR6 WGII, Ch.2 & CCP7]; deltas SSP3-scaled
        baseline:  [58, 57.3, 56.5, 55.5, 53.2, 49.5, 43.5, 38, 31.5],
        decided:   [58, 57.9, 57.7, 57.1, 56.1, 54.4, 51.3, 48.7, 46.0],
  ...
  // ─── Décision 02 — Modèle : POL_DIET_SHIFT_PLANTBASED ─────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.6, 74.2, 78, 83.4, 89, 96.5],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.7, 79.1, 85.7, 91.4, 98.8],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 01 — Modèle : POL_TRANSPORT_ELECTRIFICATION ────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.2, 73.7, 77.6, 83, 88.7, 96.1],
        pessimist: [65.2, 67.2, 69.3, 71.5, 74.4, 78.9, 85.5, 91.2, 98.6],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 08 — Solaire & éolien à grande échelle ──────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69, 70.6, 72.7, 75.7, 79.7, 85.4, 92.8],
        pessimist: [65.2, 67.2, 69.2, 71.2, 74, 78.3, 84.2, 89.9, 97.3],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 09 — Rénovation thermique des bâtiments ─────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.2, 73.8, 77.7, 84.2, 89.9, 97.3],
        pessimist: [65.2, 67.2, 69.3, 71.5, 74.4, 79.1, 86, 91.7, 99.1],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 10 — Économie circulaire dans l'industrie ───────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.4, 74.1, 78.1, 85.4, 91.1, 98.5],
        pessimist: [65.2, 67.2, 69.3, 71.5, 74.5, 79.2, 86.5, 92.2, 99.6],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 11 — CCS pour l'industrie lourde ────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.6, 74.1, 77.7, 82.7, 88.4, 95.8],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.6, 79, 85.4, 91.1, 98.5],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 12 — Expansion du nucléaire ─────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.6, 74.9, 79.2, 85.6, 91.2, 98.7],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.9, 79.7, 86.5, 92.2, 99.6],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 13 — Phase-out des gaz fluorés ───────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.1, 71.1, 73.6, 78.3, 85.6, 91.2, 98.7],
        pessimist: [65.2, 67.2, 69.2, 71.4, 74.4, 79.2, 86.5, 92.2, 99.6],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 14 — Réduction du gaspillage alimentaire ────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.4, 73.9, 77.7, 85, 90.7, 98.1],
        pessimist: [65.2, 67.2, 69.3, 71.5, 74.5, 79, 86.3, 92, 99.4],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 15 — Agroforesterie et carbone des sols ─────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.3, 73.5, 76.7, 84, 89.7, 97.1],
        pessimist: [65.2, 67.2, 69.3, 71.5, 74.3, 78.6, 85.9, 91.6, 99],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 16 — Restauration des écosystèmes ───────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.6, 74.1, 77.5, 82.3, 88, 95.4],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.6, 78.9, 85.2, 90.9, 98.3],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 17 — BECCS ───────────────────────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.6, 74.9, 79.6, 85.9, 90.7, 98.1],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.9, 79.8, 86.7, 92, 99.4],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── dec-18 — Hydrogène vert ──────────────────────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.5, 74.5, 79.1, 85.9, 90.9, 98.4],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.8, 79.6, 86.7, 92.1, 99.5],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── dec-19 — Réseaux intelligents et stockage ────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.2, 71.4, 74.5, 79.2, 86, 91.7, 99.1],
        pessimist: [65.2, 67.2, 69.3, 71.5, 74.8, 79.7, 86.7, 92.4, 99.8],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── dec-20 — Géothermie et hydroélectricité ──────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.6, 74.7, 79.6, 86.7, 92, 99.4],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.8, 79.8, 87, 92.6, 100],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── dec-21 — Normes zéro-carbone construction neuve ─────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.2, 71.5, 74.7, 79.4, 86.4, 91.7, 99.1],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.8, 79.7, 86.8, 92.4, 99.8],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.32, 1.38, 1.43, 1.48, 1.59, 1.76, 2.07, 2.38, 2.87],
  ...
  // ─── dec-22 — Efficacité appareils et éclairage ───────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.2, 71.5, 74.7, 79.4, 86.4, 92.1, 99.5],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.8, 79.7, 86.9, 92.6, 100],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── dec-24 — Décarbonation fret lourd, maritime et aérien ───────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.6, 74.8, 79.5, 86.6, 91.9, 99.3],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.9, 79.8, 86.9, 92.5, 99.9],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── dec-26 — Capture et utilisation du carbone (CCU) ────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.6, 74.8, 79.7, 86.9, 92.4, 99.8],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.9, 79.8, 87.1, 92.7, 100.1],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── dec-27 — Sobriété énergétique et modes de vie ────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.2, 71.3, 74.2, 79, 85.9, 91.6, 99.1],
        pessimist: [65.2, 67.2, 69.3, 71.5, 74.6, 79.5, 86.5, 92.2, 99.7],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── dec-28 — Finance climatique internationale ───────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.2, 71.4, 74.5, 79.1, 85.9, 91.7, 99.1],
        pessimist: [65.2, 67.2, 69.3, 71.5, 74.8, 79.7, 86.7, 92.4, 99.8],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── dec-29 — Écosystèmes côtiers ────────────────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [65.2, 67.2, 69.3, 71.5, 74.7, 79.6, 86.7, 92.4, 99.8],
        pessimist: [65.2, 67.2, 69.3, 71.6, 74.8, 79.8, 87, 92.7, 100.1],
      },
      temperature: {
        baseline:  [1.32, 1.38, 1.43, 1.49, 1.6, 1.78, 2.1, 2.44, 2.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.32, 1.38, 1.43, 1.49, 1.59, 1.77, 2.08, 2.41, 2.91],
