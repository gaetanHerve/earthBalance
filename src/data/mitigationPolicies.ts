...
// labels : [2025, 2030, 2035, 2040, 2045, 2050, 2055, 2060, 2065, 2070, 2075, 2080, 2085, 2090, 2095, 2100]
// co2    : [65.2, 67.2, 69.3, 71.6, 74.9, 79.9, 87.2, 92.9, 100.3] GtCO₂/an (fossile+LULUCF)
...
export const mitigationPolicies: MitigationPolicy[] = [
  // ─── Décision existante 42-07 ─────────────────────────────────────────────
  {
    ...
    projections: {
      labels: [2025, 2030, 2035, 2040, 2045, 2050, 2055, 2060, 2065, 2070, 2075, 2080, 2085, 2090, 2095, 2100],
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 70.3, 72.82, 75.4, 77.4, 79.4, 82.25, 85.1, 87.74, 90.39, 93.1, 96.1, 99.1, 102.1, 105.1, 108.1],
        pessimist: [66.2, 71.1, 74.6, 78.1, 81.1, 84.1, 86.95, 89.8, 92.44, 95.09, 97.8, 100.8, 103.8, 106.8, 109.8, 112.8],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.47, 1.57, 1.68, 1.81, 1.93, 2.06, 2.19, 2.34, 2.48, 2.64, 2.83, 3.02, 3.22, 3.41, 3.6],
        pessimist: [1.35, 1.48, 1.61, 1.74, 1.88, 2.03, 2.18, 2.34, 2.51, 2.68, 2.85, 3.04, 3.23, 3.43, 3.62, 3.81],
      },
      forest: {
        // % forêts primaires mondiales — baseline SSP3-7.0 [AR6 WGII, Ch.2 & CCP7]; deltas SSP3-scaled
        baseline:  [57.7, 55.5, 52.6, 49.5, 46.5, 43.5, 40.8, 38, 35.7, 33.4, 31.2, 29.8, 28.3, 26.9, 25.4, 24],
        decided:   [57.65, 55.9, 53.1, 50.1, 47.3, 44.5, 41.8, 39.1, 36.64, 34.17, 31.9, 30.5, 29, 27.6, 26.1, 24.7],
        pessimist: [57.65, 55.7, 52.8, 49.8, 46.9, 44, 41.25, 38.5, 36.11, 33.71, 31.5, 30.1, 28.6, 27.2, 25.7, 24.3],
      },
    },
  },
  ...
  // ─── Décision 05 — Modèle : POL_COAL_EXIT_2030_DEV ────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 70.5, 73.12, 75.7, 77.7, 79.7, 82.55, 85.4, 88.04, 90.69, 93.4, 96.4, 99.4, 102.4, 105.4, 108.4],
        pessimist: [66.2, 71.2, 74.72, 78.3, 81.25, 84.2, 87.05, 89.9, 92.54, 95.19, 97.9, 100.9, 103.9, 106.9, 109.9, 112.9],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.48, 1.58, 1.7, 1.84, 1.97, 2.11, 2.25, 2.4, 2.56, 2.72, 2.91, 3.1, 3.3, 3.49, 3.68],
        pessimist: [1.35, 1.48, 1.61, 1.74, 1.88, 2.03, 2.18, 2.34, 2.51, 2.68, 2.85, 3.04, 3.23, 3.43, 3.62, 3.81],
      },
    },
    prerequisites: {
  ...
  // ─── Décision 04 — Modèle : POL_METHANE_REDUCTION_2030 ────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 66.8, 70.83, 75.5, 79.35, 83.2, 86.05, 88.9, 91.54, 94.19, 96.9, 99.9, 102.9, 105.9, 108.9, 111.9],
        pessimist: [66.2, 69.9, 74.1, 78.1, 81.8, 85.5, 88.35, 91.2, 93.84, 96.49, 99.2, 102.2, 105.2, 108.2, 111.2, 114.2],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.47, 1.58, 1.7, 1.84, 1.97, 2.12, 2.27, 2.43, 2.58, 2.75, 2.94, 3.13, 3.33, 3.52, 3.71],
        pessimist: [1.35, 1.48, 1.61, 1.75, 1.9, 2.05, 2.21, 2.37, 2.55, 2.72, 2.9, 3.09, 3.28, 3.48, 3.67, 3.86],
      },
    },
  },
  ...
  // ─── Décision 03 — Modèle : POL_DEFORESTATION_HALT_2030 ───────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 70.6, 73.07, 76.9, 80.55, 84.2, 87.05, 89.9, 92.54, 95.19, 97.9, 100.9, 103.9, 106.9, 109.9, 112.9],
        pessimist: [66.2, 71.3, 74.63, 78.3, 81.9, 85.5, 88.35, 91.2, 93.84, 96.49, 99.2, 102.2, 105.2, 108.2, 111.2, 114.2],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.48, 1.57, 1.69, 1.82, 1.94, 2.08, 2.21, 2.36, 2.5, 2.66, 2.85, 3.04, 3.24, 3.43, 3.62],
        pessimist: [1.35, 1.48, 1.61, 1.75, 1.89, 2.03, 2.19, 2.35, 2.51, 2.68, 2.85, 3.04, 3.23, 3.43, 3.62, 3.81],
      },
      forest: {
        // % forêts primaires mondiales — baseline SSP3-7.0 [AR6 WGII, Ch.2 & CCP7]; deltas SSP3-scaled
        baseline:  [57.7, 55.5, 52.6, 49.5, 46.5, 43.5, 40.8, 38, 35.7, 33.4, 31.2, 29.8, 28.3, 26.9, 25.4, 24],
        decided:   [57.95, 57.1, 55.82, 54.4, 52.85, 51.3, 50, 48.7, 47.74, 46.77, 45.7, 44.3, 42.8, 41.4, 39.9, 38.5],
        pessimist: [57.75, 56.1, 53.78, 51.2, 48.85, 46.5, 44.4, 42.3, 40.44, 38.59, 36.8, 35.4, 33.9, 32.5, 31, 29.6],
      },
    },
  },
  ...
  // ─── Décision 02 — Modèle : POL_DIET_SHIFT_PLANTBASED ─────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.6, 74.83, 78, 80.7, 83.4, 86.2, 89, 91.68, 94.36, 97.1, 100.1, 103.1, 106.1, 109.1, 112.1],
        pessimist: [66.2, 71.6, 75.43, 79.1, 82.4, 85.7, 88.55, 91.4, 94.04, 96.69, 99.4, 102.4, 105.4, 108.4, 111.4, 114.4],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.61, 1.73, 1.87, 2, 2.15, 2.29, 2.44, 2.6, 2.76, 2.95, 3.14, 3.34, 3.53, 3.72],
        pessimist: [1.35, 1.49, 1.62, 1.76, 1.91, 2.06, 2.22, 2.38, 2.55, 2.72, 2.9, 3.09, 3.28, 3.48, 3.67, 3.86],
      },
      forest: {
        // % forêts primaires mondiales — baseline SSP3-7.0 [AR6 WGII, Ch.2 & CCP7]; deltas SSP3-scaled
        baseline:  [57.7, 55.5, 52.6, 49.5, 46.5, 43.5, 40.8, 38, 35.7, 33.4, 31.2, 29.8, 28.3, 26.9, 25.4, 24],
        decided:   [57.65, 55.7, 53.02, 50.1, 47.45, 44.8, 42.35, 39.9, 37.58, 35.26, 33.1, 31.7, 30.2, 28.8, 27.3, 25.9],
        pessimist: [57.65, 55.6, 52.7, 49.7, 47, 44.3, 41.6, 38.9, 36.58, 34.26, 32.1, 30.7, 29.2, 27.8, 26.3, 24.9],
      },
    },
    prerequisites: {
  ...
  // ─── Décision 01 — Modèle : POL_TRANSPORT_ELECTRIFICATION ────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.2, 74.35, 77.6, 80.3, 83, 85.85, 88.7, 91.34, 93.99, 96.7, 99.7, 102.7, 105.7, 108.7, 111.7],
        pessimist: [66.2, 71.5, 75.15, 78.9, 82.2, 85.5, 88.35, 91.2, 93.84, 96.49, 99.2, 102.2, 105.2, 108.2, 111.2, 114.2],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.48, 1.59, 1.71, 1.85, 1.99, 2.13, 2.27, 2.43, 2.59, 2.76, 2.95, 3.14, 3.34, 3.53, 3.72],
        pessimist: [1.35, 1.49, 1.62, 1.76, 1.91, 2.06, 2.22, 2.37, 2.54, 2.71, 2.89, 3.08, 3.27, 3.47, 3.66, 3.85],
      },
    },
    prerequisites: {
  ...
  // ─── Décision 08 — Solaire & éolien à grande échelle ──────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 70.6, 73.2, 75.7, 77.7, 79.7, 82.55, 85.4, 88.04, 90.69, 93.4, 96.4, 99.4, 102.4, 105.4, 108.4],
        pessimist: [66.2, 71.2, 74.72, 78.3, 81.25, 84.2, 87.05, 89.9, 92.54, 95.19, 97.9, 100.9, 103.9, 106.9, 109.9, 112.9],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── Décision 09 — Rénovation thermique des bâtiments ─────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.2, 74.45, 77.7, 80.95, 84.2, 87.05, 89.9, 92.54, 95.19, 97.9, 100.9, 103.9, 106.9, 109.9, 112.9],
        pessimist: [66.2, 71.5, 75.18, 79.1, 82.55, 86, 88.85, 91.7, 94.34, 96.99, 99.7, 102.7, 105.7, 108.7, 111.7, 114.7],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.48, 1.61, 1.75, 1.89, 2.03, 2.18, 2.34, 2.51, 2.68, 2.85, 3.04, 3.23, 3.43, 3.62, 3.81],
        pessimist: [1.35, 1.49, 1.62, 1.77, 1.92, 2.07, 2.24, 2.4, 2.58, 2.76, 2.94, 3.13, 3.32, 3.52, 3.71, 3.9],
      },
    },
    prerequisites: {
  ...
  // ─── Décision 10 — Économie circulaire dans l'industrie ───────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.4, 74.77, 78.1, 81.75, 85.4, 88.25, 91.1, 93.74, 96.39, 99.1, 102.1, 105.1, 108.1, 111.1, 114.1],
        pessimist: [66.2, 71.5, 75.28, 79.2, 82.85, 86.5, 89.35, 92.2, 94.84, 97.49, 100.2, 103.2, 106.2, 109.2, 112.2, 115.2],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.62, 1.75, 1.9, 2.05, 2.22, 2.38, 2.55, 2.72, 2.89, 3.08, 3.27, 3.47, 3.66, 3.85],
        pessimist: [1.35, 1.49, 1.63, 1.77, 1.93, 2.08, 2.25, 2.41, 2.59, 2.77, 2.95, 3.14, 3.33, 3.53, 3.72, 3.91],
      },
    },
  },
  ...
  // ─── Décision 11 — CCS pour l'industrie lourde ────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.6, 74.7, 77.7, 80.2, 82.7, 85.55, 88.4, 91.04, 93.69, 96.4, 99.4, 102.4, 105.4, 108.4, 111.4],
        pessimist: [66.2, 71.6, 75.33, 79, 82.2, 85.4, 88.25, 91.1, 93.74, 96.39, 99.1, 102.1, 105.1, 108.1, 111.1, 114.1],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.62, 1.74, 1.88, 2.01, 2.15, 2.3, 2.46, 2.61, 2.78, 2.97, 3.16, 3.36, 3.55, 3.74],
        pessimist: [1.35, 1.49, 1.62, 1.76, 1.92, 2.07, 2.22, 2.38, 2.56, 2.73, 2.91, 3.1, 3.29, 3.49, 3.68, 3.87],
      },
    },
    prerequisites: {
      policiesRequired: ['dec-07'],
  ...
  // ─── Décision 12 — Expansion du nucléaire ─────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.6, 75.62, 79.2, 82.4, 85.6, 88.4, 91.2, 93.88, 96.56, 99.3, 102.3, 105.3, 108.3, 111.3, 114.3],
        pessimist: [66.2, 71.6, 75.7, 79.7, 83.1, 86.5, 89.35, 92.2, 94.84, 97.49, 100.2, 103.2, 106.2, 109.2, 112.2, 115.2],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.63, 1.77, 1.92, 2.06, 2.22, 2.38, 2.55, 2.72, 2.9, 3.09, 3.28, 3.48, 3.67, 3.86],
        pessimist: [1.35, 1.49, 1.63, 1.77, 1.93, 2.09, 2.26, 2.42, 2.6, 2.77, 2.95, 3.14, 3.33, 3.53, 3.72, 3.91],
      },
    },
    prerequisites: {
  ...
  // ─── Décision 13 — Phase-out des gaz fluorés ───────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.1, 74.38, 78.3, 81.95, 85.6, 88.4, 91.2, 93.88, 96.56, 99.3, 102.3, 105.3, 108.3, 111.3, 114.3],
        pessimist: [66.2, 71.4, 75.2, 79.2, 82.85, 86.5, 89.35, 92.2, 94.84, 97.49, 100.2, 103.2, 106.2, 109.2, 112.2, 115.2],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.48, 1.61, 1.75, 1.9, 2.05, 2.21, 2.37, 2.54, 2.71, 2.88, 3.07, 3.26, 3.46, 3.65, 3.84],
        pessimist: [1.35, 1.49, 1.62, 1.77, 1.93, 2.08, 2.25, 2.41, 2.59, 2.77, 2.95, 3.14, 3.33, 3.53, 3.72, 3.91],
      },
    },
  },
  ...
  // ─── Décision 14 — Réduction du gaspillage alimentaire ────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.4, 74.53, 77.7, 81.35, 85, 87.85, 90.7, 93.34, 95.99, 98.7, 101.7, 104.7, 107.7, 110.7, 113.7],
        pessimist: [66.2, 71.5, 75.25, 79, 82.65, 86.3, 89.15, 92, 94.64, 97.29, 100, 103, 106, 109, 112, 115],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.62, 1.75, 1.9, 2.05, 2.21, 2.37, 2.54, 2.71, 2.88, 3.07, 3.26, 3.46, 3.65, 3.84],
        pessimist: [1.35, 1.49, 1.63, 1.77, 1.93, 2.08, 2.25, 2.41, 2.59, 2.77, 2.95, 3.14, 3.33, 3.53, 3.72, 3.91],
      },
    },
  },
  ...
  // ─── Décision 15 — Agroforesterie et carbone des sols ─────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.3, 74.03, 76.7, 80.35, 84, 86.85, 89.7, 92.34, 94.99, 97.7, 100.7, 103.7, 106.7, 109.7, 112.7],
        pessimist: [66.2, 71.5, 75.02, 78.6, 82.25, 85.9, 88.75, 91.6, 94.24, 96.89, 99.6, 102.6, 105.6, 108.6, 111.6, 114.6],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.62, 1.75, 1.89, 2.03, 2.18, 2.34, 2.51, 2.68, 2.85, 3.04, 3.23, 3.43, 3.62, 3.81],
        pessimist: [1.35, 1.49, 1.62, 1.77, 1.93, 2.08, 2.24, 2.4, 2.58, 2.76, 2.94, 3.13, 3.32, 3.52, 3.71, 3.9],
      },
      forest: {
        // % forêts primaires mondiales — baseline SSP3-7.0 [AR6 WGII, Ch.2 & CCP7]; deltas SSP3-scaled
        baseline:  [57.7, 55.5, 52.6, 49.5, 46.5, 43.5, 40.8, 38, 35.7, 33.4, 31.2, 29.8, 28.3, 26.9, 25.4, 24],
        decided:   [57.65, 56, 53.57, 50.9, 48.5, 46.1, 43.95, 41.8, 39.66, 37.51, 35.5, 34.1, 32.6, 31.2, 29.7, 28.3],
        pessimist: [57.65, 55.8, 52.92, 50, 47.55, 45.1, 42.4, 39.7, 37.38, 35.06, 32.9, 31.5, 30, 28.6, 27.1, 25.7],
      },
    },
    prerequisites: {
  ...
  // ─── Décision 16 — Restauration des écosystèmes ───────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.6, 74.67, 77.5, 79.9, 82.3, 85.15, 88, 90.64, 93.29, 96, 99, 102, 105, 108, 111],
        pessimist: [66.2, 71.6, 75.32, 78.9, 82.05, 85.2, 88.05, 90.9, 93.54, 96.19, 98.9, 101.9, 104.9, 107.9, 110.9, 113.9],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.61, 1.73, 1.87, 2, 2.15, 2.29, 2.44, 2.6, 2.76, 2.95, 3.14, 3.34, 3.53, 3.72],
        pessimist: [1.35, 1.49, 1.62, 1.76, 1.9, 2.05, 2.22, 2.38, 2.55, 2.72, 2.9, 3.09, 3.28, 3.48, 3.67, 3.86],
      },
      forest: {
        // % forêts primaires mondiales — baseline SSP3-7.0 [AR6 WGII, Ch.2 & CCP7]; deltas SSP3-scaled
        baseline:  [57.7, 55.5, 52.6, 49.5, 46.5, 43.5, 40.8, 38, 35.7, 33.4, 31.2, 29.8, 28.3, 26.9, 25.4, 24],
        decided:   [57.65, 56.2, 54.88, 53.3, 51.85, 50.4, 48.9, 47.4, 45.69, 43.97, 42.3, 40.9, 39.4, 38, 36.5, 35.1],
        pessimist: [57.65, 55.8, 53.67, 51, 48.35, 45.7, 43.3, 40.9, 38.4, 35.9, 33.6, 32.2, 30.7, 29.3, 27.8, 26.4],
      },
    },
    prerequisites: {
      policiesRequired: ['dec-03'],
  ...
  // ─── Décision 17 — BECCS ───────────────────────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.6, 75.68, 79.6, 82.75, 85.9, 88.3, 90.7, 93.34, 95.99, 98.7, 101.7, 104.7, 107.7, 110.7, 113.7],
        pessimist: [66.2, 71.6, 75.72, 79.8, 83.25, 86.7, 89.35, 92, 94.64, 97.29, 100, 103, 106, 109, 112, 115],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.63, 1.77, 1.91, 2.05, 2.21, 2.36, 2.52, 2.68, 2.85, 3.04, 3.23, 3.43, 3.62, 3.81],
        pessimist: [1.35, 1.49, 1.63, 1.77, 1.93, 2.08, 2.25, 2.41, 2.59, 2.76, 2.94, 3.13, 3.32, 3.52, 3.71, 3.9],
      },
      forest: {
        // % forêts primaires mondiales — baseline SSP3-7.0 [AR6 WGII, Ch.2 & CCP7]; deltas SSP3-scaled
        baseline:  [57.7, 55.5, 52.6, 49.5, 46.5, 43.5, 40.8, 38, 35.7, 33.4, 31.2, 29.8, 28.3, 26.9, 25.4, 24],
        decided:   [57.65, 55.3, 52.27, 49.1, 45.95, 42.8, 40, 37.2, 34.77, 32.34, 30.1, 28.7, 27.2, 25.8, 24.3, 22.9],
        pessimist: [57.65, 55.3, 52.27, 49.1, 45.9, 42.7, 39.85, 37, 34.61, 32.21, 30, 28.6, 27.1, 25.7, 24.2, 22.8],
      },
    },
    prerequisites: {
  ...
  // ─── dec-18 — Hydrogène vert ──────────────────────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.5, 75.27, 79.1, 82.5, 85.9, 88.4, 90.9, 93.58, 96.26, 99, 102, 105, 108, 111, 114],
        pessimist: [66.2, 71.6, 75.6, 79.6, 83.15, 86.7, 89.4, 92.1, 94.74, 97.39, 100.1, 103.1, 106.1, 109.1, 112.1, 115.1],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.62, 1.76, 1.91, 2.06, 2.22, 2.37, 2.55, 2.72, 2.9, 3.09, 3.28, 3.48, 3.67, 3.86],
        pessimist: [1.35, 1.49, 1.63, 1.77, 1.93, 2.08, 2.25, 2.42, 2.6, 2.78, 2.96, 3.15, 3.34, 3.54, 3.73, 3.92],
      },
    },
    prerequisites: {
      policiesRequired: ['dec-08'],
  ...
  // ─── dec-19 — Réseaux intelligents et stockage ────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.4, 75.28, 79.2, 82.6, 86, 88.85, 91.7, 94.34, 96.99, 99.7, 102.7, 105.7, 108.7, 111.7, 114.7],
        pessimist: [66.2, 71.5, 75.62, 79.7, 83.2, 86.7, 89.55, 92.4, 95.04, 97.69, 100.4, 103.4, 106.4, 109.4, 112.4, 115.4],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.48, 1.62, 1.76, 1.92, 2.07, 2.22, 2.38, 2.56, 2.73, 2.91, 3.1, 3.29, 3.49, 3.68, 3.87],
        pessimist: [1.35, 1.49, 1.63, 1.77, 1.93, 2.09, 2.26, 2.42, 2.6, 2.78, 2.96, 3.15, 3.34, 3.54, 3.73, 3.92],
      },
    },
    prerequisites: {
      policiesRequired: ['dec-08'],
  ...
  // ─── dec-20 — Géothermie et hydroélectricité ──────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.6, 75.52, 79.6, 83.15, 86.7, 89.35, 92, 94.64, 97.29, 100, 103, 106, 109, 112, 115],
        pessimist: [66.2, 71.6, 75.63, 79.8, 83.4, 87, 89.8, 92.6, 95.24, 97.89, 100.6, 103.6, 106.6, 109.6, 112.6, 115.6],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.62, 1.77, 1.92, 2.07, 2.24, 2.4, 2.58, 2.76, 2.94, 3.13, 3.32, 3.52, 3.71, 3.9],
        pessimist: [1.35, 1.49, 1.63, 1.77, 1.93, 2.09, 2.26, 2.43, 2.61, 2.79, 2.97, 3.16, 3.35, 3.55, 3.74, 3.93],
      },
    },
    prerequisites: {
      policiesRequired: ['dec-05'],
  ...
  // ─── dec-21 — Normes zéro-carbone construction neuve ─────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.5, 75.48, 79.4, 82.9, 86.4, 89.05, 91.7, 94.34, 96.99, 99.7, 102.7, 105.7, 108.7, 111.7, 114.7],
        pessimist: [66.2, 71.6, 75.62, 79.7, 83.25, 86.8, 89.6, 92.4, 95.04, 97.69, 100.4, 103.4, 106.4, 109.4, 112.4, 115.4],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.48, 1.62, 1.76, 1.92, 2.07, 2.22, 2.38, 2.56, 2.73, 2.91, 3.1, 3.29, 3.49, 3.68, 3.87],
  ...
  // ─── dec-22 — Efficacité appareils et éclairage ───────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.5, 75.48, 79.4, 82.9, 86.4, 89.25, 92.1, 94.74, 97.39, 100.1, 103.1, 106.1, 109.1, 112.1, 115.1],
        pessimist: [66.2, 71.6, 75.62, 79.7, 83.3, 86.9, 89.75, 92.6, 95.24, 97.89, 100.6, 103.6, 106.6, 109.6, 112.6, 115.6],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.62, 1.77, 1.93, 2.08, 2.25, 2.41, 2.59, 2.77, 2.95, 3.14, 3.33, 3.53, 3.72, 3.91],
        pessimist: [1.35, 1.49, 1.63, 1.78, 1.94, 2.09, 2.26, 2.43, 2.61, 2.79, 2.97, 3.16, 3.35, 3.55, 3.74, 3.93],
      },
    },
  },
  ...
  // ─── dec-24 — Décarbonation fret lourd, maritime et aérien ───────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.6, 75.58, 79.5, 83.05, 86.6, 89.25, 91.9, 94.54, 97.19, 99.9, 102.9, 105.9, 108.9, 111.9, 114.9],
        pessimist: [66.2, 71.6, 75.72, 79.8, 83.35, 86.9, 89.7, 92.5, 95.14, 97.79, 100.5, 103.5, 106.5, 109.5, 112.5, 115.5],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.63, 1.77, 1.93, 2.08, 2.24, 2.4, 2.58, 2.76, 2.94, 3.13, 3.32, 3.52, 3.71, 3.9],
        pessimist: [1.35, 1.49, 1.63, 1.78, 1.94, 2.09, 2.26, 2.43, 2.61, 2.79, 2.97, 3.16, 3.35, 3.55, 3.74, 3.93],
      },
    },
    prerequisites: {
  ...
  // ─── dec-26 — Capture et utilisation du carbone (CCU) ────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.6, 75.62, 79.7, 83.3, 86.9, 89.65, 92.4, 95.04, 97.69, 100.4, 103.4, 106.4, 109.4, 112.4, 115.4],
        pessimist: [66.2, 71.6, 75.72, 79.8, 83.45, 87.1, 89.9, 92.7, 95.34, 97.99, 100.7, 103.7, 106.7, 109.7, 112.7, 115.7],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.63, 1.77, 1.93, 2.08, 2.25, 2.41, 2.59, 2.77, 2.95, 3.14, 3.33, 3.53, 3.72, 3.91],
        pessimist: [1.35, 1.49, 1.63, 1.78, 1.94, 2.09, 2.26, 2.43, 2.61, 2.79, 2.97, 3.16, 3.35, 3.55, 3.74, 3.93],
      },
    },
    prerequisites: {
  ...
  // ─── dec-27 — Sobriété énergétique et modes de vie ────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.3, 75, 79, 82.45, 85.9, 88.75, 91.6, 94.28, 96.96, 99.7, 102.7, 105.7, 108.7, 111.7, 114.7],
        pessimist: [66.2, 71.5, 75.42, 79.5, 83, 86.5, 89.35, 92.2, 94.88, 97.56, 100.3, 103.3, 106.3, 109.3, 112.3, 115.3],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.48, 1.62, 1.76, 1.92, 2.07, 2.23, 2.39, 2.57, 2.74, 2.92, 3.11, 3.3, 3.5, 3.69, 3.88],
        pessimist: [1.35, 1.49, 1.62, 1.77, 1.93, 2.08, 2.25, 2.42, 2.6, 2.78, 2.96, 3.15, 3.34, 3.54, 3.73, 3.92],
      },
    },
  },
  ...
  // ─── dec-28 — Finance climatique internationale ───────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.4, 75.27, 79.1, 82.5, 85.9, 88.8, 91.7, 94.34, 96.99, 99.7, 102.7, 105.7, 108.7, 111.7, 114.7],
        pessimist: [66.2, 71.5, 75.62, 79.7, 83.2, 86.7, 89.55, 92.4, 95.04, 97.69, 100.4, 103.4, 106.4, 109.4, 112.4, 115.4],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
  ...
  // ─── dec-29 — Écosystèmes côtiers ────────────────────────────────────────
  {
    ...
    projections: {
      ...
      co2: {
        baseline:  [66.2, 71.6, 75.7, 79.9, 83.6, 87.2, 90.1, 92.9, 95.5, 98.2, 100.9, 103.9, 106.9, 109.9, 112.9, 115.9],  // [AR6 WGI SPM.4 — CEDA, CC-BY-4.0]
        decided:   [66.2, 71.5, 75.52, 79.6, 83.15, 86.7, 89.55, 92.4, 95.04, 97.69, 100.4, 103.4, 106.4, 109.4, 112.4, 115.4],
        pessimist: [66.2, 71.6, 75.63, 79.8, 83.4, 87, 89.85, 92.7, 95.34, 97.99, 100.7, 103.7, 106.7, 109.7, 112.7, 115.7],
      },
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.62, 1.77, 1.93, 2.08, 2.25, 2.41, 2.59, 2.77, 2.95, 3.14, 3.33, 3.53, 3.72, 3.91],
      ...
      forest: {
        // % forêts primaires mondiales — baseline SSP3-7.0 [AR6 WGII, Ch.2 & CCP7]; deltas SSP3-scaled
        baseline:  [57.7, 55.5, 52.6, 49.5, 46.5, 43.5, 40.8, 38, 35.7, 33.4, 31.2, 29.8, 28.3, 26.9, 25.4, 24],
        decided:   [57.65, 55.6, 52.72, 49.8, 46.95, 44.1, 41.35, 38.6, 36.17, 33.74, 31.5, 30.1, 28.6, 27.2, 25.7, 24.3],
        pessimist: [57.65, 55.6, 52.68, 49.6, 46.7, 43.8, 41, 38.2, 35.81, 33.41, 31.2, 29.8, 28.3, 26.9, 25.4, 24],
      },
    },
    prerequisites: {
      policiesRequired: ['dec-03'],
  ...
  // ─── dec-30 — Réduction N₂O agricole et méthane bétail ────────────────────
  {
    ...
    projections: {
      ...
      temperature: {
        baseline:  [1.35, 1.49, 1.63, 1.78, 1.94, 2.1, 2.27, 2.44, 2.62, 2.8, 2.99, 3.18, 3.37, 3.57, 3.76, 3.95],  // [AR6 WGI SPM.8 — CEDA, CC-BY-4.0]
        decided:   [1.35, 1.49, 1.62, 1.76, 1.92, 2.07, 2.23, 2.39, 2.57, 2.74, 2.92, 3.11, 3.3, 3.5, 3.69, 3.88],
        pessimist: [1.35, 1.49, 1.63, 1.77, 1.93, 2.09, 2.26, 2.42, 2.6, 2.78, 2.96, 3.15, 3.34, 3.54, 3.73, 3.92],
      },
    },
    prerequisites: {
