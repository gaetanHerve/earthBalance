...
export const systemicEdges: SysEdge[] = [
  ...
  { data: { id: 'temp_fresh',  source: 'temperature', target: 'freshwater',   type: 'negative', description: "Le réchauffement intensifie les sécheresses et perturbe le cycle hydrologique, réduisant les ressources en eau douce dans de nombreuses régions.", descriptionEn: "Warming intensifies droughts and disrupts the hydrological cycle, reducing freshwater resources in many regions.", ipccRef: 'AR6 WGII Ch.4' } },
  { data: { id: 'temp_forest', source: 'temperature', target: 'forest',       type: 'negative', description: "Les vagues de chaleur et les sécheresses amplifient les incendies de forêt et le dépérissement forestier (dieback).", descriptionEn: "Heatwaves and droughts amplify wildfires and forest dieback.", ipccRef: 'AR6 WGII Ch.2' } },
  { data: { id: 'temp_bio',    source: 'temperature', target: 'biodiversity', type: 'negative', description: "Le réchauffement dépasse les capacités d'adaptation de nombreuses espèces, provoquant des extinctions en masse et des déplacements d'aires de répartition.", descriptionEn: "Warming exceeds the adaptive capacity of many species, causing mass extinctions and range shifts.", ipccRef: 'AR6 WGII Ch.2' } },
  { data: { id: 'temp_food',   source: 'temperature', target: 'food_security',type: 'negative', description: "Le stress thermique sur les cultures, la multiplication des événements extrêmes et les perturbations hydrologiques réduisent les rendements agricoles mondiaux.", descriptionEn: "Heat stress on crops, multiplication of extreme events and hydrological disruptions reduce global agricultural yields.", ipccRef: 'AR6 WGII Ch.5' } },
  { data: { id: 'temp_health', source: 'temperature', target: 'health',       type: 'negative', description: "Le réchauffement amplifie les maladies vectorielles (paludisme, dengue), les coups de chaleur et la mortalité cardiovasculaire.", descriptionEn: "Warming amplifies vector-borne diseases (malaria, dengue), heat strokes and cardiovascular mortality.", ipccRef: 'AR6 WGII Ch.7' } },
  ...
  { data: { id: 'sea_food', source: 'sea_level', target: 'food_security', type: 'negative', description: "L'intrusion saline dans les terres agricoles côtières réduit les surfaces cultivables et la productivité des exploitations.", descriptionEn: "Saltwater intrusion into coastal agricultural land reduces arable area and farm productivity.", ipccRef: 'AR6 WGII Ch.5' } },
  ...
  { data: { id: 'res_bio', source: 'resources', target: 'biodiversity', type: 'negative', description: "L'exploitation minière, la surpêche et l'extraction forestière détruisent des habitats critiques et réduisent la biodiversité locale et mondiale.", descriptionEn: "Mining, overfishing and logging destroy critical habitats and reduce local and global biodiversity.", ipccRef: 'AR6 WGII Ch.2' } },
  ...
  // Accès eau →
  { data: { id: 'water_food',  source: 'water_access', target: 'food_security', type: 'positive', description: "L'accès à l'eau potable et à l'irrigation est indispensable à la production alimentaire et à la sécurité des ménages agricoles.", descriptionEn: "Access to drinking water and irrigation is essential for food production and agricultural household security.", ipccRef: 'AR6 WGII Ch.5' } },
  { data: { id: 'water_health',source: 'water_access', target: 'health',        type: 'positive', description: "L'accès à l'eau potable et à l'assainissement réduit drastiquement les maladies diarrhéiques, principal cause de mortalité infantile.", descriptionEn: "Access to safe water and sanitation drastically reduces diarrhoeal diseases, the primary cause of child mortality.", ipccRef: 'AR6 WGII Ch.7' } },
  ...
  // Inégalités →
  { data: { id: 'ineq_health', source: 'inequality', target: 'health',       type: 'negative', description: "Les inégalités socio-économiques limitent l'accès aux soins, à la nutrition et aux conditions de vie saines — elles amplifient tous les autres risques sanitaires.", descriptionEn: "Socio-economic inequalities limit access to healthcare, nutrition and healthy living conditions — they amplify all other health risks.", ipccRef: 'AR6 WGII Ch.7' } },
  { data: { id: 'ineq_food',   source: 'inequality', target: 'food_security',type: 'negative', description: "Les inégalités économiques privent les populations les plus vulnérables d'un accès suffisant à l'alimentation, même lorsque la production mondiale est suffisante.", descriptionEn: "Economic inequalities deprive the most vulnerable populations of adequate food access, even when global production is sufficient.", ipccRef: 'AR6 WGII Ch.5' } },
