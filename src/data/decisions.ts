  ...
  // ─── Décision 42-08 — Solaire & éolien à grande échelle ──────────────────
  {
    ...
    prospectiveNarratives: {
      ...
      moderate: {
        ...
        colorClass: 'text-yellow-400',
        borderClass: 'border-yellow-500/30',
        text: 'En 2044, le mix électrique mondial est à **58%** renouvelable, mais l\'intégration réseau reste un défi : les pics de production solaire et éolienne sont parfois perdus faute de flexibilité suffisante. Les pays à forte dépendance au charbon (Indonésie, Inde rurale, Afrique du Sud) progressent mais restent à 35% de renouvelables. La réduction nette atteint **–3,8 GtCO₂/an** — sous le potentiel maximal, mais l\'impact est historique.',
      },
      pessimistic: {
        horizon: '+50 ans',
        label: 'Scénario Pessimiste',
  ...
  // ─── Décision 42-09 — Rénovation thermique des bâtiments ─────────────────
  {
    ...
    prospectiveNarratives: {
      ...
      moderate: {
        ...
        colorClass: 'text-yellow-400',
        borderClass: 'border-yellow-500/30',
        text: 'En 2044, le taux de rénovation global reste insuffisant : seuls **28%** du parc immobilier mondial ont atteint les standards BBC (Bâtiment Basse Consommation). Les obstacles financiers pour les propriétaires modestes persistent malgré les aides. En revanche, les nouvelles constructions sont quasi-toutes à énergie positive dans les pays de l\'OCDE. Le gain net atteint **–2 GtCO₂/an** — significatif, mais la transition complète prendra encore 20 ans.',
      },
      pessimistic: {
        horizon: '+50 ans',
        label: 'Scénario Pessimiste',
  ...
  // ─── Décision 42-11 — CCS pour l'industrie lourde ────────────────────────
  {
    ...
    prospectiveNarratives: {
      ...
      pessimistic: {
        ...
        colorClass: 'text-red-400',
        borderClass: 'border-red-500/30',
        text: 'En 2074, le CCS s\'est développé mais reste prisonnier d\'une contradiction structurelle : les plus grands bénéficiaires de la technologie sont les industries fossiles, qui l\'ont utilisée pour prolonger leur activité plutôt que pour décarboner l\'économie. Les fuites de CO₂ dans certains sites mal sélectionnés ont alimenté la controverse. Le bilan net (**–0,08°C**) est inférieur aux projections — le CCS seul ne peut pas résoudre le problème climatique.',
      },
    },
    projections: {
      labels: [2024, 2026, 2028, 2030, 2034, 2040, 2050, 2060, 2074],
  ...
  // ─── Décision 42-12 — Expansion du nucléaire ─────────────────────────────
  {
    ...
    prospectiveNarratives: {
      optimistic: {
        ...
        colorClass: 'text-eb-green',
        borderClass: 'border-eb-green/30',
        text: 'En 2034, les premiers SMR (Small Modular Reactors) de nouvelle génération sont opérationnels en Pologne, en Corée du Sud et au Canada. La prolongation de **45 réacteurs** existants en Europe et aux États-Unis a évité l\'émission de **400 MtCO₂** supplémentaires. La Chine a ajouté 40 GW de capacité nucléaire supplémentaire, dépassant tous les autres pays. Le coût de construction des SMR chute grâce à la standardisation modulaire.',
      },
      moderate: {
        horizon: '+20 ans',
        label: 'Scénario Modéré',
  ...
  // ─── Décision 42-13 — Phase-out des gaz fluorés ───────────────────────────
  {
    ...
    prospectiveNarratives: {
      ...
      pessimistic: {
        ...
        colorClass: 'text-red-400',
        borderClass: 'border-red-500/30',
        text: 'En 2074, les émissions de gaz fluorés ont été largement maîtrisées pour les HFC, mais l\'explosion mondiale de la climatisation (projections : 4 milliards d\'appareils en 2050 contre 1,9 milliard en 2020) a créé un nouveau problème : les fuites d\'HFO de nouvelle génération, dont certains se dégradent en PFAS (polluants éternels) dans l\'atmosphère. La substitution des gaz fluorés a résolu un problème climatique pour en créer partiellement un autre.',
      },
    },
    projections: {
      labels: [2024, 2026, 2028, 2030, 2034, 2040, 2050, 2060, 2074],
  ...
  // ─── Décision 42-14 — Réduction du gaspillage alimentaire ────────────────
  {
    ...
    prospectiveNarratives: {
      optimistic: {
        ...
        colorClass: 'text-eb-green',
        borderClass: 'border-eb-green/30',
        text: 'En 2034, l\'objectif ODD 12.3 est atteint dans **42 pays** représentant 65% du PIB mondial. Les chaînes du froid ont été déployées dans 38 pays d\'Afrique subsaharienne et d\'Asie du Sud, réduisant les pertes post-récolte de **58%**. En Europe et en Amérique du Nord, la combinaison d\'applications anti-gaspillage (Too Good To Go, Phenix) et de nouvelles réglementations sur les DLC (dates limites de consommation) a réduit le gaspillage ménager de **40%**.',
      },
      moderate: {
        horizon: '+20 ans',
        label: 'Scénario Modéré',
