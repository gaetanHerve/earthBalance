...
This data package contains the data that powers the chart ["Energy use per person"](https://ourworldindata.org/explorers/energy?Total+or+Breakdown=Total&Energy+or+Electricity=Primary+energy&Metric=Per+capita+consumption&country=USA~GBR~CHN~OWID_WRL~IND~BRA~ZAF) on the Our World in Data website. It was downloaded on April 12, 2026.
