...
Scope analysé : Simulateur — projections CO₂/température/forêt
Date : 2026-07-01
...
```typescript
// Années de référence partagées entre simulation.store et tippingPoints.store
...
## Rapport GIEC — Simulateur — projections CO₂/température/forêt — 2026-07-01
