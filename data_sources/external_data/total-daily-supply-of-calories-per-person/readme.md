# Total daily supply of calories per person - Data package

This data package contains the data that powers the chart ["Total daily supply of calories per person"](https://ourworldindata.org/explorers/global-food?Food=All+food&Metric=Food+available+for+consumption&Per+capita=true&country=OWID_WRL~USA~CHN~IND~BRA~GBR) on the Our World in Data website. It was downloaded on April 12, 2026.
...
## Total daily supply of calories per person
...
Metric: Food supply (kcal/capita/day)
